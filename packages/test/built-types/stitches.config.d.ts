import type * as Stitches from '@volue/stitches-react';
export type { VariantProps } from '@volue/stitches-react';
export declare const styled: {
    ...
    className: string;
    selector: string;
} & (Argument0 extends string ? import("@volue/stitches-react/types/stitches").ThemeTokens<Argument1, ""> : import("@volue/stitches-react/types/stitches").ThemeTokens<Argument0, "">), getCssText: () => string, keyframes: (style: {
    [offset: string]: import("@volue/stitches-react/types/css-util").CSS<{
        bp1: "(min-width: 520px)";
        bp2: "(min-width: 900px)";
        bp3: "(min-width: 1200px)";
        bp4: "(min-width: 1800px)";
...
export declare const darkTheme: string & {
    className: string;
    selector: string;
} & import("@volue/stitches-react/types/stitches").ThemeTokens<{
    colors: {
        hiContrast: string;
        loContrast: string;
        canvas: string;
